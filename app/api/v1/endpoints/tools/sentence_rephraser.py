...
# def rephrase_text(request: Request, data: RephraseRequest):
#     """Generate rephrased versions of the input text with detailed analysis."""
#     try:
#         content = data.content.strip()

#         # Fetch model from app state
#         paraphrasing_pipeline = request.app.state.pipelines["paraphrasing"]
...
#             tone_match = data.tone.lower() in text.lower()  # Basic tone match check
